...
import { idlFactory } from './wings_publishers_backend.did.js';
export { idlFactory } from './wings_publishers_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WINGS_PUBLISHERS_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wings_publishers_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wings_publishers_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wings_publishers_backend.did.js")._SERVICE>}
 */
export const wings_publishers_backend = createActor(canisterId);
